...
class TestUploadFile:
    ...
    def test_upload_file_minimal(
        ...
        with SyncClient(strapi_config) as client:
            media = client.upload_file(test_file)
    ...
    def test_upload_file_not_found(self, strapi_config: StrapiConfig) -> None:
...
class TestDownloadFile:
    ...
    def test_download_file_to_bytes(self, strapi_config: StrapiConfig) -> None:
        ...
        with SyncClient(strapi_config) as client:
            content = client.download_file("/uploads/test.jpg")
    ...
    def test_download_file_absolute_url(self, strapi_config: StrapiConfig) -> None:
        ...
        with SyncClient(strapi_config) as client:
            content = client.download_file("https://cdn.example.com/uploads/test.jpg")
    ...
    def test_download_file_not_found(self, strapi_config: StrapiConfig) -> None:
        ...
        with SyncClient(strapi_config) as client:
            with pytest.raises(MediaError):
                client.download_file("/uploads/missing.jpg")
...
class TestListMedia:
    ...
    def test_list_media_with_filters(
        ...
        with SyncClient(strapi_config) as client:
            ...
            result = client.list_media(query)
...
class TestUpdateMedia:
    ...
    def test_update_media_alt_text(
        ...
        with SyncClient(strapi_config) as client:
            media = client.update_media(1, alternative_text="Updated alt text")
